	...
	public static function enqueue_dashboard_scripts($hook) {
		...
		wp_localize_script( 'wplman' , 'i18nStr' ,
			array(
				...
				'__sure_delete'                     => __('Are you sure to remove?' , WPLMAN_TEXTDOMAIN),
				'__edit_shortlink'                  => __('Edit shortlink' , WPLMAN_TEXTDOMAIN),
				'__detail_shortlink'                => __('Detail shortlink' , WPLMAN_TEXTDOMAIN),
				'__add_shortlink'                   => __('Add new shortlink' , WPLMAN_TEXTDOMAIN),
